function Instructions() {
  return (
    <div className="max-w-5xl mx-auto mt-20 p-4 text-left">
      {" "}
      {/* Added mt-20 for top margin */}
      <h1 className="font-mono text-slate-50 font-bold text-4xl mb-4">
        Instructions
      </h1>
      ...
      <ul className="list-disc list-inside mt-4 font-sans text-slate-300">
        ...
        <li>
          Click the '+' button on the Projects Overview page to create a new
          project.
        </li>
        <li>
          Click on a project card to view its details and manage its songs.
        </li>
        ...
        <li>
          Click the play icon on a song card to play the song in the player bar
          below.
        </li>
        <li>
          You can also use the website only using keyboards (with tabs, arrow
          keys, and enter)
        </li>
      </ul>
    </div>
